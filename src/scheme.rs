...
impl MaterialScheme {
    pub(crate) fn from_m3(s: M3Scheme, is_dark: bool) -> Self {
        Self {
            ...
            primary_fixed: c(s.primary_fixed),
            primary_fixed_dim: c(s.primary_fixed_dim),
            on_primary_fixed: c(s.on_primary_fixed),
            on_primary_fixed_variant: c(s.on_primary_fixed_variant),
            ...
            secondary_fixed: c(s.secondary_fixed),
            secondary_fixed_dim: c(s.secondary_fixed_dim),
            on_secondary_fixed: c(s.on_secondary_fixed),
            on_secondary_fixed_variant: c(s.on_secondary_fixed_variant),
            ...
            tertiary_fixed: c(s.tertiary_fixed),
            tertiary_fixed_dim: c(s.tertiary_fixed_dim),
            on_tertiary_fixed: c(s.on_tertiary_fixed),
            on_tertiary_fixed_variant: c(s.on_tertiary_fixed_variant),
